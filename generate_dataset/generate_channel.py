...
if __name__ == "__main__":
    ...
    #channel = generate_channel_dataset(50000,Nt = 64,Nr = 4, K = 20, B = 4, Lp = 10, f_s = 0.32*1e9, tap_range = 100)
    #save_root = '/home/zmj/LCP_dataset/dataset/channel_dataset.mat'
    #hdf5storage.savemat(save_root,{'H_list':channel})
    channel = generate_channel_dataset(4000,Nt = 16,Nr = 2, K = 10, B = 1, Lp = 10, f_s = 0.32*1e9, tap_range = 100)
    save_root = '/home/zmj/LCP_dataset/dataset/channel_dataset_small.mat'
    hdf5storage.savemat(save_root,{'H_list':channel})
