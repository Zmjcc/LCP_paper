...
if __name__ == "__main__":
    ...
    channel = generate_channel_dataset(5000,Nt = 64,Nr = 4, K = 20, B = 5, Lp = 10, f_s = 0.32*1e9, tap_range = 100)
    save_root = '/home/zmj/LCP_dataset/converting_loss_test_dataset.mat'
